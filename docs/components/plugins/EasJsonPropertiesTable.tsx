...
export function createDescription(propertyEntry: [string, Property]) {
  ...
  if (propertyValue.meta && propertyValue.meta.genericWorkflow) {
    propertyDescription += `<genericworflowDetails>${propertyValue.meta.bareWorkflow}</genericworkflowDetails>`;
  }
